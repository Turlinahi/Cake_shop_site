    ...
    setInterval(function(){
      ...
      if(counter > 3){
        ...
        <div class="box1">
            ...
            <a href="Get%20your%20Cake%20Memories.html"><h3>Get your Cake Memories</h3></a>
            <p>Exciting news for all baking lovers and aspiring cooking chefs – with Cris Cakes you can make your own cake with delicious vanilla, chocolate or strawberry cakes! Add awesome colorful bows, hearts, sprinkles or fruit pieces on top of your marvelous cakes and have fun serving yummy desserts!
            </p>
            <h2>Click here and choose your cake!</h2>
        </div>
